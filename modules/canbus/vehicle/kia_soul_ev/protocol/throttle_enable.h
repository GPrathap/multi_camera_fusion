...
/**
 * @file steering_64.h
 * @brief the class of ThrottleEnable (for kia_soul_ev vehicle)
 */

#ifndef MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_THROTTLE_ENABLE_H_
#define MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_THROTTLE_ENABLE_H_
...
/**
 * @class ThrottleEnable
 *
 * @brief one of the protocol data of kia_soul_ev vehicle
 */
class ThrottleEnable : public ::apollo::drivers::canbus::ProtocolData<
