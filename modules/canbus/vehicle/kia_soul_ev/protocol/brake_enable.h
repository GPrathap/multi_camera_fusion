...
/**
 * @file steering_64.h
 * @brief the class of BrakeEnable (for kia_soul_ev vehicle)
 */

#ifndef MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_BRAKE_ENABLE_H_
#define MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_BRAKE_ENABLE_H_
 ...
 */
class BrakeEnable : public ::apollo::drivers::canbus::ProtocolData<
