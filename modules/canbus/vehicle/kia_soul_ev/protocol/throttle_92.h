...
/**
 * @file throttle_62.h
 * @brief the class of Throttle92 (for kia_soul_ev vehicle)
 */

#ifndef MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_THROTTLE_62_H_
#define MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_THROTTLE_62_H_
 ...
 */
class Throttle92 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
   ...
   */
  Throttle92 *set_pedal(double pcmd);

  /**
   * @brief set enable
   * @return a this pointer to the instance itself
   */
  Throttle92 *set_enable();

  /**
   * @brief set disable
   * @return a this pointer to the instance itself
   */
  Throttle92 *set_disable();

  /**
   * @brief set enable ignore driver override
   * @return a this pointer to the instance itself
   */
  Throttle92 *set_enable_ignore_driver_override();
...
#endif  // MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_THROTTLE_62_H_
