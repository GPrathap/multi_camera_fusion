...
#ifndef MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_WHEELS_4B0_H_
#define MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_WHEELS_4B0_H_
 ...
 */
class Wheels4B0 : public ::apollo::drivers::canbus::ProtocolData<
