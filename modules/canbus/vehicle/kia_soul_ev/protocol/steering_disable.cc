...
const int32_t SteeringDisable::ID = 0x81;

uint32_t SteeringDisable::GetPeriod() const {
  // receive rate??
...
bool SteeringDisable::NeedSend(){
  bool tmp = send_once_;
  send_once_ = false;
  return tmp;
}

void SteeringDisable::UpdateData(uint8_t *data) {

    oscc_steering_disable_s disable_cmd;
...
void SteeringDisable::send_once(){
