...
/**
 * @file steering_64.h
 * @brief the class of BrakeDisable (for kia_soul_ev vehicle)
 */

#ifndef MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_BRAKE_DISABLE_H_
#define MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_BRAKE_DISABLE_H_
 ...
 */
class BrakeDisable : public ::apollo::drivers::canbus::ProtocolData<
