...
/**
 * @file steering_64.h
 * @brief the class of SteeringEnable (for kia_soul_ev vehicle)
 */

#ifndef MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_STEERING_ENABLE_H_
#define MODULES_CANBUS_VEHICL_KIASOULEV_PROTOCOL_STEERING_ENABLE_H_
...
/**
 * @class SteeringEnable
 *
 * @brief one of the protocol data of kia_soul_ev vehicle
 */
class SteeringEnable : public ::apollo::drivers::canbus::ProtocolData<
