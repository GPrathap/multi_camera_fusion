#ifndef PYLON_CAMERA_INCLUDE_PYLON_CAMERA_USBCAMWRAPPER_H_
#define PYLON_CAMERA_INCLUDE_PYLON_CAMERA_USBCAMWRAPPER_H_
...
namespace pylon_camera
{
    ...
    class PylonCamWrapper
    {
    public:
        PylonCamWrapper(ros::NodeHandle node, ros::NodeHandle private_nh);
        virtual ~PylonCamWrapper();
        ...
        void set_camera_parameters(const ros::NodeHandle& nh);
...
#endif /* PYLON_CAMERA_INCLUDE_PYLON_CAMERA_USBCAMWRAPPER_H_ */
