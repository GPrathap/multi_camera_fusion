...
using ImageFrontLeftSideAdapter = Adapter<::sensor_msgs::Image>;
using ImageFrontRightSideAdapter = Adapter<::sensor_msgs::Image>;
using ImageRightAdapter = Adapter<::sensor_msgs::Image>;
using ImageLeftAdapter = Adapter<::sensor_msgs::Image>;
using ImageRightBackwardsSideAdapter = Adapter<::sensor_msgs::Image>;
using ImageLeftBackwardsSideAdapter = Adapter<::sensor_msgs::Image>;
using ImageFrontCameraAdapter = Adapter<::sensor_msgs::Image>;
...
using OdometryGnssAdapter = Adapter<::nav_msgs::Odometry>;
