...
DEFINE_string(parking_conf_file, "modules/parking/conf/parking_conf.pb.txt",
              "default parking conf data file");

DEFINE_string(parking_adapter_config_filename,
              "modules/parking/conf/adapter.conf", "The adapter config file");
